      ...
      <div className="container mx-auto px-6 max-w-6xl relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-2 mb-6">
              <img
                ...
                alt="Lenfolk"
                className="h-20 w-auto object-contain mt-[-10px] ml-[-10px]"
              />
            </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-gray-500">
              {['Trang chủ', 'Giới thiệu', 'Khóa học', 'Tin tức'].map(
                (link) => (
                  <li key={link}>
                    <Link
                      href="#"
                      className="hover:text-[#8e9e6e] transition-colors"
                    >
                      {link}
                    </Link>
                  </li>
        ...
        <div className="border-t border-gray-100 pt-8 flex flex-col md:grid md:grid-cols-2 lg:grid-cols-6 gap-6 lg:gap-8 items-center md:items-start lg:items-center">
          <div className="flex gap-4 lg:col-span-2 w-full justify-center md:justify-start">
            <a
              href="https://www.facebook.com/profile.php?id=61590024181109"
              target="_blank"
              rel="noopener noreferrer"
              className="w-9 h-9 rounded-full bg-gray-500 flex items-center justify-center text-white hover:bg-gray-700 transition-colors"
            >
              <svg
                width="18"
                height="18"
            ...
            <a
              href="https://www.tiktok.com/@lenfolk3?_r=1&_t=ZS-96k1lxAtcmL"
              target="_blank"
              rel="noopener noreferrer"
              className="w-9 h-9 rounded-full bg-gray-500 flex items-center justify-center text-white hover:bg-gray-700 transition-colors"
            >
              <svg
                ...
                fill="currentColor"
              >
                <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 15.68a6.34 6.34 0 0 0 6.27 6.36 6.34 6.34 0 0 0 6.25-6.36V7.93a8.11 8.11 0 0 0 1.94.24v-3.4a4.08 4.08 0 0 1-1.87-.24h2v2.16z" />
              </svg>
            </a>
          </div>
          ...
          <div className="text-gray-400 text-base lg:col-span-2 text-center md:text-left w-full">
            <a
              href="mailto:crony1705@gmail.com"
              className="hover:text-gray-600 transition-colors flex items-center justify-center md:justify-start gap-2"
            >
              <Mail size={24} />
