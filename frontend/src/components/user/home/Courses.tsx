      ...
      <div className="container mx-auto px-6">
        ...
        <div className="bg-gradient-to-br from-sage-dark to-sage-light rounded-[40px] p-8 md:p-12 text-white mb-12 relative overflow-hidden shadow-2xl shadow-sage-dark/20 flex flex-col md:flex-row gap-12 items-center">
           ...
           <div className="w-full md:w-3/5 relative z-10">
             ...
             <div className="text-2xl font-bold mb-6 text-cream">1.200.000đ <span className="text-lg font-normal text-white/80">/ tháng</span></div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-24">
          {courses.map((course) => (
            <div key={course.id} className="bg-white rounded-[32px] p-8 md:p-10 border border-gray-100 shadow-xl shadow-gray-200/50 flex flex-col hover:border-sage-light transition-colors">
               ...
               <p className="text-gray-600 mb-8 flex-1">{course.desc}</p>
               
               <div className="space-y-4 mb-10">
                 {course.features.map((feat: string, i: number) => (
                   <div key={i} className="flex items-start gap-3">
                     <div className="mt-1 bg-sage-light/30 text-sage-dark p-1 rounded-full"><Check size={14} /></div>
               ...
               <button 
                  ...
                  className="w-full py-4 border-2 border-black text-black font-bold rounded-full hover:bg-black hover:text-white transition-colors mt-auto"
                >
                 Đăng ký
               </button>
            </div>
