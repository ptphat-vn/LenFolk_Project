          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-24">
            <div className="w-full lg:w-1/2 flex flex-col justify-center">
              <div className="flex flex-row items-end gap-4 md:gap-8 mb-10 relative">
                ...
                <svg
                  className="absolute -top-6 md:-top-10 left-4 md:left-12 w-32 md:w-56 text-[#c5d1b3] -rotate-3 z-0"
                  viewBox="0 0 200 30"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <path
                    d="M5 25 Q 50 5, 120 15 T 195 10"
                    stroke="currentColor"
                    strokeWidth="6"
                    strokeLinecap="round"
                    opacity="0.8"
                  />
                  <path
                    d="M20 28 Q 70 8, 140 18 T 185 15"
                    stroke="currentColor"
                    strokeWidth="3"
                    strokeLinecap="round"
                    opacity="0.4"
                ...
                <h3 className="text-8xl md:text-[140px] font-black tracking-tighter text-black leading-[0.85] relative z-10">
                  01
                </h3>
                <div className="pb-2 md:pb-4 relative z-10">
                  <h4 className="text-3xl md:text-5xl font-bold uppercase text-black mb-2 tracking-tight">
                    Tối Giản
                  </h4>
                  <p className="text-[10px] md:text-xs font-semibold text-gray-500 tracking-[0.2em] uppercase">
                    Nghệ thuật từ sáu lỗ bấm
                  </p>
                </div>
              </div>
              ...
              <div className="max-w-md pt-8 border-t border-gray-200 relative">
                ...
                <span className="text-xs font-bold text-black uppercase tracking-widest mb-4 block relative z-10">
                  01 / 03
                </span>
                <p className="text-gray-500 leading-relaxed text-[15px] relative z-10">
                  Không cần nhạc lý hàn lâm hay phím bấm phức tạp. Chỉ với 6 lỗ
                  bấm mộc mạc, bạn đã sở hữu chiếc chìa khóa mở ra thế giới vạn
                  giai điệu, biến những cảm xúc vô hình thành âm thanh trong
                  trẻo.
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            <div className="w-full lg:w-1/4 flex flex-col justify-between order-2 lg:order-1 h-full py-10 relative">
              ...
              <div className="mb-10 lg:mb-0 relative z-10">
                <h4 className="text-4xl md:text-[56px] font-bold uppercase text-black leading-none mb-4 tracking-tight">
                  An Yên
                </h4>
                <p className="text-[10px] md:text-xs font-semibold text-gray-500 tracking-[0.2em] uppercase">
                  Thanh âm của chánh niệm
                </p>
              </div>
            ...
            <div className="w-full lg:w-1/4 flex flex-col justify-center order-3 h-full py-10">
              <div className="flex flex-col items-start mb-10 relative">
                ...
                <div className="text-xl font-bold text-gray-300 uppercase tracking-widest mb-4 relative z-10">
                  02 / 03
                </div>
                <span className="text-6xl md:text-7xl font-black text-black leading-none mb-2 relative z-10">
                  15'
                </span>
                <span className="text-[10px] md:text-xs font-semibold text-gray-500 tracking-[0.2em] uppercase relative z-10">
                  Dành cho bạn
                </span>
              </div>
              <p className="text-gray-500 leading-relaxed text-[15px]">
                Tiếng sáo là sự kết tạo của nhịp thở và tâm hồn. Dành 15 phút
                mỗi ngày cùng sáo trúc giúp bạn điều hòa lồng ngực, giải tỏa áp
                lực và tìm lại khoảng lặng bình yên nguyên bản giữa nhịp sống
                hiện đại.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-24">
            <div className="w-full lg:w-1/2 order-2 lg:order-1 flex flex-col justify-center">
              <div className="flex justify-between items-start mb-16">
                <h4 className="text-5xl md:text-[72px] font-bold uppercase text-black tracking-tight leading-none">
                  Tự Do
                </h4>
                <div className="text-right">
                  <span className="text-sm font-bold text-black uppercase tracking-widest block">
                    03 / 03
                  </span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-12 mb-12">
                <div>
                  <h5 className="text-4xl md:text-5xl font-black text-black mb-3">
                    100%
                  </h5>
                  <p className="text-[10px] md:text-xs font-semibold text-gray-500 tracking-[0.2em] uppercase">
                    Tự nhiên
              ...
              <div className="pt-10 border-t border-gray-200 relative">
                ...
                <h5 className="text-[10px] md:text-xs font-semibold text-sage-dark tracking-[0.2em] uppercase mb-4 relative z-10">
                  Giai điệu không giới hạn
                </h5>
                <p className="text-gray-500 leading-relaxed text-[15px] relative z-10">
                  Được chế tác hoàn toàn từ tre nứa tự nhiên, gọn nhẹ trong balo
                  và không cần dây cắm hay pin sạc. Sáo trúc là nhạc cụ tự do
                  nhất, sẵn sàng cùng bạn tấu lên giai điệu ở bất cứ nơi đâu
                  bước chân bạn đặt tới.
                </p>
              </div>
            </div>
