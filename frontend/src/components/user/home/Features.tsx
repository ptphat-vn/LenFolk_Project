    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          >
            {/* UI Top */}
            <div className="bg-gradient-to-br from-[#e8eddf]/80 to-[#f4e0ac]/40 rounded-[20px] p-5 mb-5 h-[250px] flex flex-col gap-3 border border-white/50 shadow-inner">
          ...
          >
            ...
            {/* UI Bottom */}
            <div className="bg-gradient-to-br from-[#e8eddf]/80 to-[#f4e0ac]/40 rounded-[20px] p-5 mt-auto h-[250px] flex flex-col gap-2.5 border border-white/50 shadow-inner">
          ...
          >
            {/* UI Top */}
            <div className="bg-gradient-to-br from-[#e8eddf]/80 to-[#f4e0ac]/40 rounded-[20px] p-5 mb-5 h-[250px] flex flex-col justify-center gap-2 border border-white/50 shadow-inner overflow-hidden">

              <div className="bg-white/50 backdrop-blur-sm rounded-full px-4 py-2.5 flex items-center gap-3 shadow-sm border border-white/60">
