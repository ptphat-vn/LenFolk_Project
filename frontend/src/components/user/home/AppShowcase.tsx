    ...
    <section className="py-24 bg-white relative">
      <div className="container mx-auto px-6">
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          >
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-black leading-tight mt-4">
          ...
          >
            ...
            <div className="absolute top-[55%] left-1/2 -translate-x-1/2 -translate-y-1/2 w-[450px] h-[350px] bg-[#C5D0B5] rounded-[50%] blur-[120px] opacity-100 z-0 pointer-events-none"></div>
