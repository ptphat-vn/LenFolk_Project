...
const PhoneMockup = ({
  ...
  >
    <div
      className={`relative overflow-hidden rounded-[2.1rem] bg-gray-50 h-full shadow-inner ${innerClassName}`}
    >
    ...
    <section className="relative min-h-screen pt-32 pb-10 flex flex-col items-center justify-center overflow-hidden bg-white">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        <div
          ...
          style={{
            background:
              'conic-gradient(from 0deg at 50% 50%, #d6ddc6 0deg, #f4e0ac 90deg, #d6ddc6 180deg, #8e9e6e 270deg, #d6ddc6 360deg)',
            WebkitMaskImage:
              'radial-gradient(circle, transparent 400px, black 480px, black 520px, transparent 600px)',
            maskImage:
              'radial-gradient(circle, transparent 400px, black 480px, black 520px, transparent 600px)',
          }}
        />
      ...
      <div className="container mx-auto px-6 relative z-10 flex flex-col items-center text-center mt-5">
        ...
        >
          AI cảm nhận từng tiếng sáo giúp nâng tầm trải nghiệm{' '}
          <br className="hidden md:block" />
          để mọi giai điệu ngân vang chuẩn xác
        </motion.p>
        ...
        >
          <img
            ...
            style={{
              WebkitMaskImage:
                'linear-gradient(to bottom, black 50%, transparent 70%)',
              maskImage:
        ...
        >
          ...
          <Link
            href="/about"
            className="px-8 py-3.5 rounded-full bg-[#f5f5f5] text-[#333] font-medium text-[17px] hover:bg-[#ebebeb] transition-all hover:-translate-y-1 shadow-md w-[200px] flex items-center justify-center"
          >
            Tìm hiểu thêm
          </Link>
        </motion.div>
