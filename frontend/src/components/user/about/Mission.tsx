...
export const Mission = () => {
  return (
    <div className="font-be-vietnam-pro flex flex-col gap-6 mx-4 md:mx-6 my-24">
      ...
      <section className="bg-[#637250] text-white py-20 md:py-32 rounded-[40px] overflow-hidden relative shadow-inner">
        ...
        <div className="container mx-auto px-6 lg:px-12 max-w-[1400px] relative z-10">
          ...
          >
            ...
            ĐƯA{' '}
            <span className="text-[#DCD74C] inline-block -translate-y-1 lg:-translate-y-2">
              →
            </span>{' '}
            TINH HOA SÁO TRÚC <br className="hidden md:block" />
            <span className="hidden md:inline-block w-32"></span>ĐẾN GẦN THẾ HỆ
            TRẺ VIỆT
          </motion.h1>
        </div>
      ...
      {/* Bottom Content */}
      <section
        className="text-black py-2 md:py-20 relative"
        style={{ clipPath: 'inset(-300px -300px -300px -300px)' }}
      >
        {/* Green Glow */}
            ...
            <div className="md:col-span-9 lg:col-span-8 lg:translate-x-[250px]">
              <p className="text-3xl md:text-4xl lg:text-5xl font-be-vietnam-pro leading-[1.2] md:leading-[1.1] tracking-[-0.02em] text-left">
                <span className="text-black">
                  <span className="hidden md:inline-block w-16"></span>Đồng hành
                  cùng thế hệ trẻ
                  <br />
                  LENFOLK{' '}
                </span>
          ...
          <div className="flex flex-col gap-24 lg:gap-32">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-24">
              <div className="w-full lg:w-1/2 flex flex-col justify-center relative">
                ...
                <p className="text-gray-600 text-lg leading-relaxed font-light mb-10 max-w-lg relative z-10">
                  Tiếng sáo bắt nguồn từ hơi thở của con người. Việc đưa AI vào
                  là cách chúng ta “số hóa” hơi thở đó. Nó đại diện cho tính
                  hiện đại, sự chính xác của công nghệ và sự lan tỏa không giới
                  hạn.
                </p>
              </div>
              <div className="w-full lg:w-5/12 flex justify-center relative">
                ...
                <div className="absolute -left-12 md:-left-24 top-1/4 -rotate-12 flex gap-3 md:gap-4 text-[#8aa667] text-2xl md:text-3xl opacity-60 pointer-events-none z-0">
                  ...
                  <span
                    className="translate-y-4 animate-pulse"
                    style={{ animationDelay: '0.2s' }}
                  >
                    ♫
                  </span>
                  <span
                    className="translate-y-8 animate-pulse"
                    style={{ animationDelay: '0.4s' }}
                  >
                    ♬
                  </span>
                  <span
                    className="translate-y-12 animate-pulse"
                    style={{ animationDelay: '0.6s' }}
                  >
                    ♪
                  </span>
                  <span
                    className="translate-y-16 animate-pulse"
            ...
            <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-24">
              ...
              <div className="w-full lg:w-1/2 flex flex-col justify-center order-1 lg:order-2 relative">
                ...
                <p className="text-gray-600 text-lg leading-relaxed font-light mb-10 max-w-lg relative z-10">
                  Khẳng định sáo là hồn cốt dân tộc, là giá trị văn hóa không
                  bao giờ lỗi thời. Dù công nghệ có thay đổi, cái “tâm” và cái
                  “tình” trong tiếng sáo vẫn nguyên vẹn.
                </p>
              </div>
            </div>
          </div>
