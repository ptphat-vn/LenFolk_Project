      ...
      >
        ...
        {!isCollapsed && (
          <span className="text-[15px] font-bold text-gray-900 overflow-hidden whitespace-nowrap">
            LenFolk
            <span className="text-blue-700"> Giảng viên</span>
          </span>
        )}
      </div>
      ...
      <div className="border-t border-gray-100 shrink-0">
        ...
        {!isCollapsed && (
          <div className="flex items-center gap-2.5 px-4 py-3 border-b border-gray-100">
            <div className="w-7 h-7 rounded-full bg-blue-800 text-white text-[11px] font-bold flex items-center justify-center shrink-0">
              {avatarInitial}
            </div>
            ...
            <span className="text-[9px] font-bold px-1.5 py-0.5 rounded bg-blue-100 text-blue-800 uppercase shrink-0">
              Giảng viên
            </span>
          </div>
        )}
