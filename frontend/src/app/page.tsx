      ...
      >
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-[#10120C]/70">
            <Link href="#" className="hover:text-[#8E9E6E] transition-colors">
              Về chúng tôi
            </Link>
            <Link href="#" className="hover:text-[#8E9E6E] transition-colors">
              Khoá học
...
rounded-full transition-all duration-300 text-sm"
      ...
      <main className="flex-1 flex flex-col items-center justify-center pt-20 px-6 relative overflow-hidden">
        ...
        <motion.div
          ...
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-200 h-200 bg-[#D6DDC6]/50 rounded-full blur-[120px] pointer-events-none"
        />
        <motion.div
          ...
          className="absolute top-0 right-0 w-125 h-125 bg-[#F4E0AC]/50 rounded-full blur-[100px] pointer-events-none"
        />
        <motion.div
          ...
          className="absolute bottom-0 left-0 w-150 h-150 bg-[#8E9E6E]/20 rounded-full blur-[120px] pointer-events-none"
        />
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto flex flex-col items-center">
          ...
          >
            Khám phá phương pháp học tập độc quyền từ LenFolk. Kết nối với các
            chuyên gia, nâng cao kỹ năng và tự tin theo đuổi con đường âm nhạc
            chuyên nghiệp.
          </motion.p>
